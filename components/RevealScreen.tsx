...
const RevealScreen: React.FC<RevealScreenProps> = ({ gameData, onFinish }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center space-y-8 animate-in fade-in duration-500">
      ...
      <div className="glass w-full p-8 rounded-3xl flex flex-col items-center justify-center min-h-[300px] text-center space-y-6 relative overflow-hidden">
        {!isRevealed ? (
          <>
          ...
          <div className="animate-in zoom-in duration-300">
            {currentPlayer.isImpostor ? (
              ...
              <>
                ...
                <p className="mt-4 text-slate-300">Dovrai dire una sola parola attinente senza svelarla troppo all'impostore!</p>
              </>
            )}
            <div className="mt-8">
